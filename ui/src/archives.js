  ...
  view: function () {
    return (
      <div class="leading-tight">
        ...
        <div class="flex flex-wrap justify-start items-center mt-2 px-2">
  ...
  view: function () {
    return (
      <div class="m-2 w-auto h-full">
        ...
        <p class="mb-2">
          No preview is available for 
          <span class="font-semibold">{PATH.path.match(/\.[^\.]*$/)}</span> files.
    ...
    return (
      <span class="mr-2">
        <button href=""
          ...
          onclick={ActionCreateArchive.create}
        >
